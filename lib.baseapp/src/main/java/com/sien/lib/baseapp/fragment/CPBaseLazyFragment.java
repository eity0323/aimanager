 ...
 * @author sien
 * @date 2016/8/26
 * @descript 基类懒加载fragment
 */
public abstract class CPBaseLazyFragment extends CPBaseFragment{
    private static final String TAG = CPBaseLazyFragment.class.getSimpleName();
