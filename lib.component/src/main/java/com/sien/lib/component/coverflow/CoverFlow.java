...
public class CoverFlow extends TwoWayGallery {
    ...
    public void setmUnselectedScale(float mUnselectedScale) {
        this.mUnselectedScale = mUnselectedScale;
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.CPCoverFlow);
        mUnselectedScale = a.getFloat(R.styleable.CPCoverFlow_unselectedScale, DEFAULT_UNSELECTED_SCALE);
        mCoverage = a.getFloat(R.styleable.CPCoverFlow_coverage, DEFAULT_COVERAGE);
        a.recycle();
    }
