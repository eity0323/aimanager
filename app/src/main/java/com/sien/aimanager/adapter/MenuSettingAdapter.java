 ...
 * @descript 设置adapter
 */
public class MenuSettingAdapter extends CPBaseRecyclerAdapter<SettingBean> {
    public MenuSettingAdapter(RecyclerView v, Collection<SettingBean> data){
        super(v,data, R.layout.item_menu_setting_adapter);
    }
