 ...
 * @author sien
 * @date 2016/11/1
 * @descript 线程池管理(线程统一调度管理)
 */
public class CPThreadPoolManager {
    private static CPThreadPoolManager sThreadPoolManager = new CPThreadPoolManager();
     ...
     * 线程池单例创建方法
     */
    public static CPThreadPoolManager newInstance() {
