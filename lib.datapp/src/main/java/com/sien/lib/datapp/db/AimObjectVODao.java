...
/** 
 * DAO for table "AIM_OBJECT_VO".
*/
public class AimObjectVODao extends AbstractDao<AimObjectVO, Long> {

    public static final String TABLENAME = "AIM_OBJECT_VO";

    /**
     * Properties of entity AimObjectVO.<br/>
    ...
    public AimObjectVODao(DaoConfig config) {
        super(config);
    }
    
    public AimObjectVODao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"AIM_OBJECT_VO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"AIM_OBJECT_VO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, AimObjectVO entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, AimObjectVO entity) {
        stmt.clearBindings();
    ...
    @Override
    public AimObjectVO readEntity(Cursor cursor, int offset) {
        AimObjectVO entity = new AimObjectVO( //
    ...
    @Override
    public void readEntity(Cursor cursor, AimObjectVO entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(AimObjectVO entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(AimObjectVO entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(AimObjectVO entity) {
