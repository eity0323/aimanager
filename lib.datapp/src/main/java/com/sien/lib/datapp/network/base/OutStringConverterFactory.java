 ...
 * @author sien
 * @date 2016/10/17
 * @descript 自定义retrofit 字符串解析工具类（解析返回参数）
 */
public class OutStringConverterFactory extends Converter.Factory {

    public static OutStringConverterFactory create() {
        return new OutStringConverterFactory();
    }
